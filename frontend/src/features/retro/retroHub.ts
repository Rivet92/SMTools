...
export const addVotePoint = (cardId: string) =>
  hubInvoke<RoomState>('AddVotePoint', cardId);
export const removeVotePoint = (cardId: string) =>
  hubInvoke<RoomState>('RemoveVotePoint', cardId);
