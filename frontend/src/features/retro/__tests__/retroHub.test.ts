...
const mockConnectionApi: HubConnectionApi<{ id: string; ownParticipantId: string; version: number; phase: string }> = {
...
let capturedListeners: HubListeners<{ id: string; ownParticipantId: string; version: number; phase: string }> | undefined;
...
vi.mock('../../../hubs/createHubConnection', () => ({
  createHubConnection: <TState>(
    ...
    capturedListeners = listeners as unknown as HubListeners<{ id: string; ownParticipantId: string; version: number; phase: string }>;
