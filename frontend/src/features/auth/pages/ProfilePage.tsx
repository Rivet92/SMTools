                  ...
                  <Typography variant="body2">
                    {key === 0
                      ...
                      : key === 1
                        ...
                        : key === 2
                          ? t('profile.exportSection')
                          : t('profile.deleteSection')}
                  </Typography>
                </Box>
              );
            })}
        ...
        <Box sx={{ flex: 1, p: 2, overflow: 'auto' }}>
                    ...
                    <TableHead>
                      <TableRow>
                        <TableCell sx={{ fontWeight: 600 }}>
                          {t('profile.activityColAction')}
                        </TableCell>
                        <TableCell sx={{ fontWeight: 600 }}>
                          {t('profile.activityColEntity')}
                        </TableCell>
                        <TableCell sx={{ fontWeight: 600 }}>
                          {t('profile.activityColTime')}
                        </TableCell>
          ...
          {activeSection === 2 && (
            <Box maxWidth={640}>
              ...
              >
                {exportMutation.isPending ? t('profile.exporting') : t('profile.exportButton')}
              </Button>
      ...
      <GenericDialog
        ...
        actions={
          <>
            ...
            >
              {deleteMutation.isPending ? t('profile.deleting') : t('profile.deleteConfirmButton')}
            </Button>
          </>
        }
      >
        <DialogContentText sx={{ mb: 2 }}>{t('profile.deleteConfirmText')}</DialogContentText>
