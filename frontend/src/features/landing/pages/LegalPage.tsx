...
const config = window.__LEGAL_CONFIG__ ?? { owner: 'SMTools', email: 'admin@example.com', showDisclaimer: true };
    ...
    <>
      ...
      <Container maxWidth="lg" sx={{ pt: 2, pb: 6 }}>
        <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 4 }}>
          <Link component={RouterLink} to="/" underline="none" color="inherit" sx={{ '&:hover': { textDecoration: 'none' } }}>
            <Typography variant="h5" component="span" fontWeight={600} sx={{ fontFamily: '"Orbitron", sans-serif', lineHeight: 1 }}>
              {t('app.title')}
            </Typography>
          </Link>
        ...
        <Box sx={{ textAlign: 'justify', '& a': { color: 'inherit', textDecoration: 'none', '&:hover': { textDecoration: 'underline' } } }}>
