...
const mockMutations = {
  create: {
    ...
    error: null,
    reset: vi.fn(),
  } as unknown as UseMutationResult<Note, Error, { title: string; content: string }>,
  update: {
    mutateAsync: vi.fn(),
    isPending: false,
    error: null,
    ...
    Note,
    Error,
    { noteId: string; request: { title?: string; content?: string } }
  >,
  remove: {
    mutate: vi.fn(),
    mutateAsync: vi.fn(),
  ...
  toggleArchive: {
    ...
    error: null,
    reset: vi.fn(),
  } as unknown as UseMutationResult<Note, Error, string>,
  reorder: {
    mutate: vi.fn(),
    isPending: false,
    error: null,
    reset: vi.fn(),
  } as unknown as UseMutationResult<void, Error, Array<{ noteId: string; position: number }>>,
};
